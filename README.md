...
```sh
git clone https://github.com/Rosforl/nomad-plugin-pldmoda.git
cd nomad-plugin-pldmoda
...
```sh
pip install dist/nomad-plugin-pldmoda-0.1.0
```
...
| Name | E-mail     |
|------|------------|
| Rosario Forlenza | [rosarioforlenza92@gmail.com](mailto:rosarioforlenza92@gmail.com)
